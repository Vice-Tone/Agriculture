...
public class Jxcbuyorder {
    ...
    public boolean equals(Object o) {
        ...
        Jxcbuyorder that = (Jxcbuyorder) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, supplier, receiptsCode, goodInfo, receiptsdate, receiptslongdate, operator, total);
    }
}
